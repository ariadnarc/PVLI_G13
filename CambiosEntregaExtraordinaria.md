...
- **Tiers:** hemos eliminado todas las clases que calculaban la probabilidad de obtención y que clasificaba los jeroglíficos y hemos añadido una clase en el config con los datos de sus símbolos y a qué letra corresponden.
- **SoundManager:** se ha modificado el sistema de sonido creando un SoundManager que controla el audio y sonidos globalmente.
- **Sala Secreta:** se ha implementado el sistema de la sala que comprueba tus jeroglíficos para ver si puedes acceder y que te entrega un array de recompensas.
